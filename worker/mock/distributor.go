...
// Source: github.com/thanhquy1105/simplebank/worker (interfaces: TaskDistributor)
//
...
import (
	...
	worker "github.com/thanhquy1105/simplebank/worker"
...
func (m *MockTaskDistributor) Close() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Close")
}
